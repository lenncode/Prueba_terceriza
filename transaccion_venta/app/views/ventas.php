<?php
// Aquí puedes incluir lógica de procesamiento o validación, si es necesario

// Redirige a la página de ventas.php
...
<div class="row">
    ...
    <div class="col-sm-3">
        <a href="views/ventas.php" class="btn btn-secondary">
